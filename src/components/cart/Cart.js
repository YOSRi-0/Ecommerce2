            ...
            <div className="cart__products__product">
              ...
              <div className="cart__products__item">
                ...
                <div className="cart__products__item__row">
                  ...
                  <p className="cart__products__item__row-value">black</p>
                </div>
                <div className="cart__products__item__row">
                  <p className="cart__products__item__row-key">size</p>
                  <p className="cart__products__item__row-value">small</p>
                </div>
                <div className="cart__products__item__row">
                ...
                <div className="cart__products__item__row">
                  ...
                  <p className="cart__products__item__row-value">$19.99</p>
                </div>
                <div className="cart__products__item__row">
