  ...
  return (
    <section id="newsletter">
      <div className="newsletter container">
        ...
        <p className="newsletter-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet
          luctus venenatis, lectus magna fringilla urna, porttitor</p>
        <div className="newsletter__sign_up">
          <input className="newsletter__sign_up-input" type="text" placeholder="Enter email address" />
